			...
			<body>
				<div id="sitemap">
					...
					<div id="sitemap__content">
						<p class="text">Número de las URL en este mapa del sitio XML: <xsl:value-of select="count( sitemap:sitemapindex/sitemap:sitemap )" />.</p>
...
Served from: localhost @ 2024-03-06 11:57:15 by W3 Total Cache
-->